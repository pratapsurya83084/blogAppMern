...
>
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        {/* Desktop Menu */}
        <nav className={`hidden md:flex ${darkMode?"text-white"||"bg-black":"text-black"||"bg-white"} space-x-6 items-center`}>
          <Link to="/" className=" hover:text-indigo-500">Home</Link>
          <Link to="/about" className=" hover:text-indigo-500">About</Link>
          <Link to="/project" className=" hover:text-indigo-500">Projects</Link>
      ...
      {/* Mobile Menu Items */}
      {menuOpen && (
        <div className={`md:hidden mt-2 px-4 pb-4 space-y-2 ${darkMode?"text-white"||"bg-black":"text-black"||"bg-white"}  rounded `}>
